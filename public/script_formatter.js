        ...
        if (cacheData) {
            ...
            Object.keys(draftsCache).forEach(isrcCode => {
                ...
                row.innerHTML = `
                    ...
                    <td><span class="table_svg_icon" onclick="copyTranscriptionFromCache('${isrcCode}')">
                    ...
                    <td><span class="table_svg_icon" onclick="exportDraft('${isrcCode}')">
                    ...
                    <td><span class="table_svg_icon" onclick="deleteDraft('${isrcCode}')">
